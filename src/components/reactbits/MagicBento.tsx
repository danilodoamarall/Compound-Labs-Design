...
export interface BentoCardProps {
  ...
  description?: string;
  label?: string;
  /** Ajuste local: o card vira link quando recebe href. */
  href?: string;
...
export interface BentoProps {
  ...
  /** Ajuste local: os cards vêm de fora; sem isso usa o conteúdo de exemplo. */
          ...
          {items.map((card, index) => {
            ...
            if (enableStars) {
              return (
                ...
                >
                  {card.href ? (
                    <a href={card.href} className="absolute inset-0 z-20 rounded-[20px]" aria-label={card.title}>
